        ...
        {isCollapsed ? (
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 transition-all duration-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
            ...
            <FlipCard
              ...
              backContent={
                <div className="bg-gradient-to-r from-green-100 to-green-200 border border-green-300 rounded-lg p-2 text-center h-full flex flex-col justify-center relative">
                  ...
                  <button 
                    ...
                    className="absolute bottom-1 right-1 w-6 h-6 bg-white text-green-700 border border-green-300 rounded-full hover:bg-green-700 hover:text-white transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
                  >
            ...
            <FlipCard
              ...
              backContent={
                <div className="bg-gradient-to-r from-amber-100 to-amber-200 border border-amber-300 rounded-lg p-2 text-center h-full flex flex-col justify-center relative">
                  <p className="text-xs font-semibold text-amber-800 mb-1">Details</p>
                  ...
                  <button 
                    ...
                    className="absolute bottom-1 right-1 w-6 h-6 bg-white text-amber-700 border border-amber-300 rounded-full hover:bg-amber-700 hover:text-white transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
                  >
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <FlipCard
              ...
              backContent={
                <div className="bg-gradient-to-r from-rose-100 to-rose-200 border border-rose-300 rounded-lg p-2 text-center h-full flex flex-col justify-center relative">
                  <p className="text-xs font-semibold text-rose-800 mb-1">Breakdown</p>
                  ...
                  <button 
                    ...
                    className="absolute bottom-1 right-1 w-6 h-6 bg-white text-rose-700 border border-rose-300 rounded-full hover:bg-rose-700 hover:text-white transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
                  >
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <FlipCard
              ...
              backContent={
                <div className="bg-gradient-to-r from-emerald-100 to-emerald-200 border border-emerald-300 rounded-lg p-2 text-center h-full flex flex-col justify-center relative">
                  <p className="text-xs font-semibold text-emerald-800 mb-1">Metrics</p>
                  ...
                  <button 
                    ...
                    className="absolute bottom-1 right-1 w-6 h-6 bg-white text-emerald-700 border border-emerald-300 rounded-full hover:bg-emerald-700 hover:text-white transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
                  >
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
